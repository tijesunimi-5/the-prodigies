...
const graduates = [
  ...
  },
  {
    ...
    status: "Engaged",
    skill: "Photographer",
    hobbies: "Documenting beautiful memories (photographing) and listening to music",
    quote: "Seek first the kingdom of God and his righteousness, and every other thing shall be added to you. Matthew 6:33",
    oneWord: "Ambitious",
    origin: "Edo state",
    whatsapp: "",
    email: "alexgodwin204@gmail.com"
  },
  {
    name: "Olakanmi Olayide Elizabeth",
    image: "/olayide.jpg",
    dob: "May 9th",
    unit: "Sanctuary keepers",
    department: "Medical laboratory science",
    moment: "Praise session",
    status: "Single",
    skill: "Nil",
    ...
    origin: "Oyo state",
    whatsapp: "",
    email: "olayideolakanmi1@gmail.com"
  },
  {
    name: "Oyewole Victoria Adesewa",
    image: "/oyewole-vic.jpg",
    dob: "May 31st",
    unit: "Sanctuary keepers, Hospitality",
    department: "Medical laboratory science",
    moment: "Worship session and drama ministration",
    status: "Single",
    skill: "Mobilegraphy skill",
    hobbies: "Reading inspirational books, listening to music, watching movies.",
    quote: "Romans 8:28; And we know that all things work together for good to them that love God, to them who are the called according to his purpose",
    oneWord: "Intentional",
    origin: "Ogun state",
    whatsapp: "",
    email: "victoriaoyewole31@gmail.com"
  },
  {
    ...
    unit: "Ushering unit",
    department: "Nursing",
    moment: "Always the drama presentation",
    status: "Single",
    skill: "Dog breeder",
    hobbies: "Reading",
    quote: "A man can receive nothing, unless it is given him from heaven is a biblical principle from John 3:27",
    oneWord: "Loving",
    origin: "Oyo state",
    whatsapp: "",
  ...
  {
    name: "Alao Abisola Rachel",
    image: "/abisola.jpg",
    dob: "March 24",
    unit: "Choir",
    department: "Pure and Applied Chemistry",
    moment: "Choir night rehearsals and Thanksgiving",
    status: "Single",
    skill: "Apparel",
    hobbies: "Reading novels, listening to music",
    quote: "Psa 27:4. One thing have I desired of the LORD, that will I seek after; that I may dwell in the house of the LORD all the days of my life, to behold the beauty of the LORD, and to inquire in his temple",
    oneWord: "Evolving",
    origin: "Osun state",
    whatsapp: "",
    email: "alaoabisola24@gmail.com",
  },
  {
    name: "Ashaju Abiodun Elizabeth",
    image: "/abiodun.jpg",
    dob: "December 16th",
    unit: "Hospitality",
    department: "English and Literary Studies",
    moment: "Praise and worship session",
    status: "In a Relationship",
    skill: "Bukunmi Luxury H ",
    hobbies: "Writing and Reading",
    quote: "Romans 8:31___If the Lord is for me who can be against me",
    oneWord: "Resilient",
    origin: "Ekiti State",
    whatsapp: "",
    email: "asiwajuabiodun16@gmail.com"
  },
  {
    name: "Tolulope Abigeal Solanke ",
    image: "/**.jpg",
    dob: "'October 30",
    unit: "Protocol",
    department: "Animal Nutrition and Biotechnology ",
    moment: "Praise and worship session",
    status: "Single",
    skill: "Kasunkaji Enterprise ",
    hobbies: "Sleeping",
    quote: "John 14:27 “Peace I leave with you, my peace I give unto you: not as the world giveth, give I unto you. Let not your heart be troubled, neither let it be afraid.”",
    oneWord: "Expressive",
    origin: "Ogun State",
    whatsapp: "",
    email: "solanketolulope990@gmail.com "
  },
  {
    name: "Aluko Chichi Temiloluwa ",
    image: "/chichi.jpg",
    dob: "April 6th",
    unit: "Choir, Children's Teacher",
    department: "Animal Production and Health ",
    moment: "Praise& Worship, Sunday school, and Drama Ministration ",
    status: "Single",
    skill: "Fragrance Curator",
    hobbies: "Cooking, Reading, and doing things that makes me happy.",
    quote: "Ephesians 2:4",
    oneWord: "Visionary",
    origin: "Osun State",
    whatsapp: "",
    email: "alukochichi@gmail.com"
  },
  {
    name: "Akinleye Fulfilment Ooreofeoluwa",
    image: "/fulfiment.jpeg",
    dob: "July 28th",
    unit: "Sanctuary Keepers, Drama Unit",
  ...
  {
    name: "Babalola Josephine Adesola ",
    image: "/babalola.jpg",
    dob: "March 29th",
    unit: "Choir, Sanctuary Keepers, Hospitality",
    department: "Anatomy department",
    moment: "Every moment is the presence of God is worthwhile",
    status: "Single",
    skill: "Makeup Artistry/Data analysis enthusiast",
    hobbies: "Singing,Sleeping and Cooking",
    quote: "Psalms 71:6 By thee have i been holden up from the womb:thou art he that took me out of my Mother's bowels:my praise shall be continually of thee. I am as a wonder unto many;but thou art my strong refuge.",
    oneWord: "Resilient",
    origin: "Zion State🙄",
    whatsapp: "",
    email: "babalolajosephineadesola@gmail.com"
  }, {
    name: "OLUWANIFEMI O. ARIBISALA",
    image: "/nifemi.jpg",
    dob: "'FEBRUARY 20",
    unit: "Sanctuary Keepers, Hospitality",
    department: "ANATOMY",
    moment: "Sunday School ",
    status: "Single",
    skill: "UI/UX Enthusiast",
    hobbies: "Video editing,  Snacking, Interesting discussions with friends ",
    quote: "Hebrews 13:8",
    oneWord: "Creative ",
    origin: "Ondo State",
    whatsapp: "",
    email: "aribisalaoluwanifemi95@gmail.com"
  },
  {
    name: "Ibirogba Matthew",
    image: "/matthew.jpg",
    dob: "March 8th",
    unit: "Sanctuary Keepers, Hospitality",
    department: "Computer Science ",
    moment: "None",
    status: "Single",
    skill: "Prefer not to mention",
    hobbies: "Sleeping",
    quote: "No permanent enemy or friend. It's an interest driven world",
    oneWord: "Industrious",
    origin: "Jerusalem",
    whatsapp: "",
